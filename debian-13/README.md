# Debian 13 bare VM
This creates a very bare Debian trixie VM template for proxmox with the following settings :
- Q35 machine and UEFI bios (UKI as I implemented it is not working in this release, will have to deal with this later)
- Cloud-init
